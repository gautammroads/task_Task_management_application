...
import * as ClientActions from '../actions/task.actions';
...
export function selectClientId(c: Tasks): string {
    return c._id;
}

export function sortByName(a: Tasks, b: Tasks): number {
    return a.name.localeCompare(b.name);
}

export function sortByCode(a: Tasks, b: Tasks): number {
