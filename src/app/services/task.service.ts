...
export class ClientService {
  ...
  save(client: Tasks): Observable<Tasks> {
    return this.http.post<Tasks>(this.apiUrl, client)
      .pipe(
        catchError(this.handleError)
      );
  }

  update(id: string, client: Tasks): Observable<Tasks> {
    return this.http.put<Tasks>(this.apiUrl + '/' + id, client)
      .pipe(
        catchError(this.handleError)
      );
  }  
